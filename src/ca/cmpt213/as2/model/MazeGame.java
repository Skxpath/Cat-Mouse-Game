...
import ca.cmpt213.as2.gui.UIObserverInterface;
...
public class MazeGame {
	...
	private List<UIObserverInterface> observers = new ArrayList<>();

	public void notifyAllObservers(){
		for (UIObserverInterface observer : observers) {
			observer.update();
		}
	}

	public void addObserver(UIObserverInterface observer){
